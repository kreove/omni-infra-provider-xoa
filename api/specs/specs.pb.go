...
func (x *MachineSpec) GetTemplateId() string {
	if x != nil {
		return x.TemplateId
	}
	return ""
...
const file_specs_specs_proto_rawDesc = "" +
	"\n" +
	"\x11specs/specs.proto\x12\bemuspecs\"\x85\x01\n" +
	"\vMachineSpec\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12\x1c\n" +
	"\tschematic\x18\x02 \x01(\tR\tschematic\x12#\n" +
	"\rtalos_version\x18\x03 \x01(\tR\ftalosVersion\x12\x1f\n" +
	"\vtemplate_id\x18\x04 \x01(\tR\n" +
	"templateIdB5Z3github.com/kreove/omni-infra-provider-xoa/api/specsb\x06proto3"
