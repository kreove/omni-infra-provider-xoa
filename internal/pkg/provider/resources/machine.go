...
// Package resources contains resources stored in the XOA provider state.
package resources
...
import (
	...
	"github.com/kreove/omni-infra-provider-xoa/api/specs"
	providermeta "github.com/kreove/omni-infra-provider-xoa/internal/pkg/provider/meta"
)
...
// Machine describes XOA machine provisioning state.
